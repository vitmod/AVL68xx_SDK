...
AVL_ErrorCode DVBC_GetSignalQuality_Demod(AVL_puint16 puiQuality , AVL_uint32 uiChipNo)
{
    ...
    if ((lock_status == AVL_STATUS_LOCK)&&(r == AVL_EC_OK))
    {
        ...
        II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, 
        gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBC_config_reg_base + rc_DVBC_j83b_mode_caddr_offset,
...
AVL_ErrorCode AVL_Demod_DVBCSignalDetection(AVL_uchar *pucNoSig, AVL_uint32 uiChipNo)
{
    AVL_ErrorCode r = AVL_EC_OK;
    AVL_uint32 uiTemp = 1;
    ...
    r = II2C_Read32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr,
                gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBC_status_reg_base + rc_DVBC_no_signal_input_iaddr_offset,&uiTemp);
