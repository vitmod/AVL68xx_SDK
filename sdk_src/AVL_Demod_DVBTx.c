...
AVL_ErrorCode AVL_Demod_DVBTxGetScanInfo(AVL_DVBTxScanInfo* pstDVBTxScanInfo, AVL_uint32 uiChipNo)
{
    ...
    r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr,
...
AVL_ErrorCode AVL_Demod_DVBT2GetPLPList(AVL_puchar pucPLPIndexArray, AVL_puchar pucPLPNumber, AVL_uint32 uiChipNo)
{
    ...
    for(i = 0; i<ucTemp; i++)
    {
        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr,uiPLPBuffer++, &ucPLPID);
        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr,uiPLPBuffer++, &ucPLPType);
        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr,uiPLPBuffer++, &ucPLPGroupID);
...
AVL_ErrorCode AVL_Demod_DVBTxGetModulationInfo(AVL_DVBTxModulationInfo *pstModulationInfo, AVL_uint32 uiChipNo)
{
    ...
    if(AVL_DVBTx_Standard_T == current_standard)
    {
        ...
        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBT_TPS_reg_base + rs_DVBTx_transmission_mode_caddr_offset,&ucTemp);
        pstModulationInfo->eDVBTSingalInfo.eDVBTFFTSize = (AVL_DVBT_FFTSize)ucTemp;
        
        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBT_TPS_reg_base + rs_DVBTx_guard_interval_caddr_offset,&ucTemp);
        pstModulationInfo->eDVBTSingalInfo.eDVBTGuardInterval = (AVL_DVBT_GuardInterval)ucTemp;
        
        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBT_TPS_reg_base + rs_DVBTx_constellation_caddr_offset,&ucTemp);
        pstModulationInfo->eDVBTSingalInfo.eDVBTModulationMode = (AVL_DVBT_ModulationMode)ucTemp;
        
        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBT_TPS_reg_base + rs_DVBTx_hierarchy_caddr_offset,&ucTemp);
        pstModulationInfo->eDVBTSingalInfo.eDVBTHierarchy = (AVL_DVBT_Hierarchy)ucTemp;

        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBT_TPS_reg_base + rs_DVBTx_HP_code_rate_caddr_offset,&ucTemp);
        ...
        {
            r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBT_TPS_reg_base + rs_DVBTx_LP_code_rate_caddr_offset,&ucTemp);
    ...
    else if(AVL_DVBTx_Standard_T2 == current_standard)
    {
        ...
        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBT2_P1_reg_base + rs_DVBTx_FFT_size_caddr_offset,&ucTemp);
        pstModulationInfo->eDVBT2SingalInfo.eDVBT2FFTSize = (AVL_DVBT2_FFTSize)ucTemp;
        
        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBT2_P1_reg_base + rs_DVBTx_MISO_SISO_caddr_offset,&ucTemp);
        pstModulationInfo->eDVBT2SingalInfo.eDVBT2MISOorSISO = (AVL_DVBT2_MISO_SISO)ucTemp;

        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBT2_P1_reg_base + rs_DVBTx_T2_profile_caddr_offset,&ucTemp);
        pstModulationInfo->eDVBT2SingalInfo.eDVBT2Profile = (AVL_DVBT2_PROFILE)ucTemp;

        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBT2_L1_pre_reg_base + rs_DVBTx_PILOT_PATTERN_caddr_offset,&ucTemp);
        pstModulationInfo->eDVBT2SingalInfo.eDVBT2PilotPatten = (AVL_DVBT2_PILOT_PATTERN)ucTemp;

        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBT2_data_PLP_config_reg_base + rs_DVBTx_data_PLP_TYPE_caddr_offset,&ucTemp);
        pstModulationInfo->eDVBT2SingalInfo.eDVBT2DataPLPType = (AVL_DVBT2_DATA_PLP_TYPE)ucTemp;
        
        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBT2_data_PLP_config_reg_base + rs_DVBTx_data_PLP_ID_caddr_offset,&ucTemp);
        pstModulationInfo->eDVBT2SingalInfo.ucDVBT2DataPLPID = ucTemp;

        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBT2_data_PLP_config_reg_base + rs_DVBTx_data_PLP_COD_caddr_offset,&ucTemp);
        pstModulationInfo->eDVBT2SingalInfo.eDVBT2DataPLPCodeRate = (AVL_DVBT2_CodeRate)ucTemp;

        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBT2_data_PLP_config_reg_base + rs_DVBTx_data_PLP_MOD_caddr_offset,&ucTemp);
        pstModulationInfo->eDVBT2SingalInfo.eDVBT2DataPLPModulationMode= (AVL_DVBT2_PLP_ModulationMode)ucTemp;

        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBT2_data_PLP_config_reg_base + rs_DVBTx_data_PLP_ROTATION_caddr_offset,&ucTemp);
        pstModulationInfo->eDVBT2SingalInfo.eDVBT2DataPLPRotation= (AVL_DVBT2_PLP_Constellation_Rotation)ucTemp;

        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBT2_data_PLP_config_reg_base + rs_DVBTx_data_PLP_FEC_TYPE_caddr_offset,&ucTemp);
...
AVL_ErrorCode DVBTx_GetSNR_Demod(AVL_puint32 puiSNR_db, AVL_uint32 uiChipNo)
{
    ...
    r = II2C_Read16_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBTx_status_reg_base + rs_DVBTx_snr_dB_x100_saddr_offset,&uiTemp);
...
AVL_ErrorCode IRx_GetSSI(AVL_puint32 puiSSI, AVL_int32 RF_Power, AVL_uint32 uiChipNo)
{
   ...
   current_standard = (AVL_DemodMode)uiTemp;
    ...
    case AVL_DVBTX:
        ...
        if(lock_status == AVL_STATUS_LOCK) 
        {
            r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBTx_status_reg_base + rs_DVBTx_rx_mode_caddr_offset,&ucTemp);
            current_dvbtx_std = (AVL_DVBTx_Standard)ucTemp;
        }
...
AVL_ErrorCode IRx_GetSQI_DVBT(AVL_puint32 puiSQI, AVL_uint32 uiChipNo)
{
    ...
    {
        //get selected layer
        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr,gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBTx_config_reg_base + rc_DVBTx_dvbt_layer_select_caddr_offset,(AVL_puchar)&selected_layer);
