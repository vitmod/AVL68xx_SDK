...
AVL_ErrorCode InitSemaphore_Demod(AVL_uint32 uiChipNo)
{
    ...
    static AVL_uchar gReceiver_sem_inited_chip0 = 0;          //receiver semaphore initialization indicator
    static AVL_uchar gDisqec_sem_inited_chip0 = 0;            //Disqec operation semaphore indicator
    static AVL_uchar gReceiver_sem_inited_chip1 = 0;          //receiver semaphore initialization indicator
    static AVL_uchar gDisqec_sem_inited_chip1 = 0;            //Disqec operation semaphore indicator
    static AVL_uchar gI2C_sem_inited = 0;               //I2C operation semaphore indicator

    if(uiChipNo == 0)
    {
      if( 0 == gReceiver_sem_inited_chip0 )
      {
        gReceiver_sem_inited_chip0 = 1;
        r |= AVL_IBSP_InitSemaphore(&(gstChipInternalArray[uiChipNo].semRx));
      }
      if( 0 == gDisqec_sem_inited_chip0 )
      {
        gDisqec_sem_inited_chip0 = 1;
        r |= AVL_IBSP_InitSemaphore(&(gstChipInternalArray[uiChipNo].stDVBSxPara.semDiseqc));
      }
    }
    if(uiChipNo == 1)
    {
      if( 0 == gReceiver_sem_inited_chip1 )
      {
        gReceiver_sem_inited_chip1 = 1;
        r |= AVL_IBSP_InitSemaphore(&(gstChipInternalArray[uiChipNo].semRx));
      }
      if( 0 == gDisqec_sem_inited_chip1 )
      {
        gDisqec_sem_inited_chip1 = 1;
        r |= AVL_IBSP_InitSemaphore(&(gstChipInternalArray[uiChipNo].stDVBSxPara.semDiseqc));
      }
    }
...
void IBase_LoadRegisterBaseAddr_Demod(AVL_uint32 uiChipNo)
{
    ...
    case AVL68XX:
        ...
        gstChipInternalArray[uiChipNo].stBaseAddrSet.hw_gpio_modu_002_base       = 0x124010;
        gstChipInternalArray[uiChipNo].stBaseAddrSet.hw_emerald_io_base          = 0x10c000;
        ...
        gstChipInternalArray[uiChipNo].stBaseAddrSet.hw_dma_sys_status_base      = 0x110048;
        gstChipInternalArray[uiChipNo].stBaseAddrSet.hw_dma_sys_cmd_base         = 0x110050;
        gstChipInternalArray[uiChipNo].stBaseAddrSet.hw_dvb_gen1_fec__base       = 0x140000;
...
AVL_ErrorCode InitErrorStat_Demod(AVL_uint32 uiChipNo)
{
   ...
   // r |=ISDBT_ResetLayerPER_Demod(uiChipNo);
...
AVL_ErrorCode SetPLL0_Demod(AVL_uint32 uiChipNo)
{
    ...
    if(DivRefHz < 16000000)
        ...
        PLLRange = 3;
    r = II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_sys_pll_divr, pPLL_Conf->m_PLL_CoreClock_DivR-1);//DIVR
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_sys_pll_divf, pPLL_Conf->m_PLL_CoreClock_DivF-1);//DIVF
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_sys_pll_divq, pPLL_Conf->m_PLL_CoreClock_DivQ-1);//DIVQ1
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_sys_pll_range, PLLRange);//range
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_sys_pll_divq2, pPLL_Conf->m_PLL_DDCClock_DivQ-1);//DIVQ2
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_sys_pll_divq3, pPLL_Conf->m_PLL_SDRAMClock_DivQ-1);//DIVQ3
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_sys_pll_enable2, (pPLL_Conf->m_PLL_DDCClock_sel == hw_E2_PLL_SEL_CORE));
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_sys_pll_enable3, (pPLL_Conf->m_PLL_SDRAMClock_sel == hw_E2_PLL_SEL_CORE));
    ...
    if(DivRefHz < 16000000)
        ...
        PLLRange = 3;
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_mpeg_pll_divr, pPLL_Conf->m_PLL_MPEGClock_DivR-1);
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_mpeg_pll_divf, pPLL_Conf->m_PLL_MPEGClock_DivF-1);
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_mpeg_pll_divq, pPLL_Conf->m_PLL_MPEGClock_DivQ-1);
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_mpeg_pll_range, PLLRange);
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_mpeg_pll_divq2, pPLL_Conf->m_PLL_DDCClock_DivQ-1);
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_mpeg_pll_divq3, pPLL_Conf->m_PLL_SDRAMClock_DivQ-1);
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_mpeg_pll_enable2, (pPLL_Conf->m_PLL_DDCClock_sel == hw_E2_PLL_SEL_MPEG));
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_mpeg_pll_enable3, (pPLL_Conf->m_PLL_SDRAMClock_sel == hw_E2_PLL_SEL_MPEG));
    ...
    if(DivRefHz < 16000000)
        ...
        PLLRange = 3;
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_adc_pll_divr, pPLL_Conf->m_PLL_ADCClock_DivR-1);
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_adc_pll_divf, pPLL_Conf->m_PLL_ADCClock_DivF-1);
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_adc_pll_divq, pPLL_Conf->m_PLL_ADCClock_DivQ-1);
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_adc_pll_range, PLLRange);
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_adc_pll_divq2, pPLL_Conf->m_PLL_DDCClock_DivQ-1);
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_adc_pll_divq3, pPLL_Conf->m_PLL_SDRAMClock_DivQ-1);
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_adc_pll_enable2, (pPLL_Conf->m_PLL_DDCClock_sel == hw_E2_PLL_SEL_ADC));
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_adc_pll_enable3, (pPLL_Conf->m_PLL_SDRAMClock_sel == hw_E2_PLL_SEL_ADC));

    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_reset_register, 0);
    II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_reset_register, 1);//no I2C ACK
    AVL_IBSP_Delay(1);



    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_dll_out_phase, 96);
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_dll_rd_phase, 0);
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_deglitch_mode, 1);
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_dll_init, 1);
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, hw_E2_AVLEM61_dll_init, 0);
...
AVL_ErrorCode IBase_CheckChipReady_Demod(AVL_uint32 uiChipNo)
{
    ...
    r |= II2C_Read32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr,rs_core_ready_word_iaddr_offset, &uiCoreReadyWord);
    if( (AVL_EC_OK == r) )
    {
...
AVL_ErrorCode IBase_SendRxOPWait_Demod(AVL_uchar ucOpCmd, AVL_uint32 uiChipNo )
{
    ...
    if( AVL_EC_OK == r )
    {
        ...
        r |= II2C_Write16_Demod(gstChipInternalArray[uiChipNo].usI2CAddr,  
...
AVL_ErrorCode IBase_GetRxOPStatus_Demod(AVL_uint32 uiChipNo)
{
    ...
    r = II2C_Read16_Demod(gstChipInternalArray[uiChipNo].usI2CAddr,
...
AVL_ErrorCode SetTSMode_Demod(AVL_uint32 uiChipNo)
{
    ...
    if(gstChipInternalArray[uiChipNo].stTSConfig.eClockMode == AVL_TS_CONTINUOUS_ENABLE)
    {
        ...
        if(gstChipInternalArray[uiChipNo].stTSConfig.eMode == AVL_TS_SERIAL)
        {
            ...
            {
#if 1
                uiTSFrequencyHz = gstChipInternalArray[uiChipNo].uiTSFrequencyHz/2;
#else
                uiTSFrequencyHz = gstChipInternalArray[uiChipNo].uiTSFrequencyHz;
#endif
                r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr,
                    gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_config_reg_base + rc_ts_cntns_clk_frac_n_iaddr_offset,uiTSFrequencyHz);
...
AVL_ErrorCode SetSleepPLL0_Demod(AVL_uint32 uiChipNo)
{
    ...
    r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, 0x100000, 0);
    II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, 0x100000, 1);//no I2C ACK
    AVL_IBSP_Delay(1);
...
AVL_ErrorCode II2C_Read_Demod( AVL_uint16 uiSlaveAddr, AVL_uint32 uiOffset, AVL_puchar pucBuff, AVL_uint32 uiSize)
{
    AVL_ErrorCode r = AVL_EC_OK;
...
AVL_ErrorCode II2C_Read8_Demod( AVL_uint16 uiSlaveAddr, AVL_uint32 uiAddr, AVL_puchar puiData )
{
    AVL_ErrorCode r = AVL_EC_OK;
    AVL_uchar Data = 0;

    r = II2C_Read_Demod(uiSlaveAddr, uiAddr, &Data, 1);
    if( AVL_EC_OK == r )
    {
        *puiData = Data;
    }
...
AVL_ErrorCode II2C_Read16_Demod( AVL_uint16 uiSlaveAddr, AVL_uint32 uiAddr, AVL_puint16 puiData )
{
    AVL_ErrorCode r = AVL_EC_OK;
    AVL_uchar pBuff[2] = {0};

    r = II2C_Read_Demod(uiSlaveAddr, uiAddr, pBuff, 2);
    if( AVL_EC_OK == r )
    {
...
AVL_ErrorCode II2C_Read32_Demod( AVL_uint16 uiSlaveAddr, AVL_uint32 uiAddr, AVL_puint32 puiData )
{
    AVL_ErrorCode r = AVL_EC_OK;
    AVL_uchar pBuff[4] = {0};

    r = II2C_Read_Demod(uiSlaveAddr, uiAddr, pBuff, 4);
    if( AVL_EC_OK == r )
    {
...
AVL_ErrorCode II2C_ReadDirect_Demod( AVL_uint16 uiSlaveAddr, AVL_puchar pucBuff, AVL_uint16 uiSize)
{
    AVL_ErrorCode r = AVL_EC_OK;
    AVL_uint16 ui1 = 0;
    AVL_uint32 ui2 = 0;
...
AVL_ErrorCode II2C_WriteDirect_Demod( AVL_uint16 uiSlaveAddr, AVL_puchar pucBuff, AVL_uint16 uiSize)
{
    AVL_ErrorCode r = AVL_EC_OK;
    AVL_uint16 ui1 = 0;
    AVL_uint32 ui2 = 0;
...
AVL_ErrorCode II2C_Write_Demod( AVL_uint16 uiSlaveAddr, AVL_puchar pucBuff, AVL_uint32 uiSize)
{
    AVL_ErrorCode r = AVL_EC_OK;
...
AVL_ErrorCode II2C_Write8_Demod( AVL_uint16 uiSlaveAddr, AVL_uint32 uiAddr, AVL_uchar ucData )
{
    AVL_ErrorCode r = AVL_EC_OK;
    AVL_uchar pBuff[4] = {0};
    ...
    r = II2C_Write_Demod(uiSlaveAddr, pBuff, 4);

    return(r);
}

AVL_ErrorCode II2C_Write16_Demod( AVL_uint16 uiSlaveAddr, AVL_uint32 uiAddr, AVL_uint16 uiData )
{
    AVL_ErrorCode r = AVL_EC_OK;
    AVL_uchar pBuff[5] = {0};
    ...
    r = II2C_Write_Demod(uiSlaveAddr, pBuff, 5);

    return(r);
}

AVL_ErrorCode II2C_Write32_Demod( AVL_uint16 uiSlaveAddr, AVL_uint32 uiAddr, AVL_uint32 uiData )
{
    AVL_ErrorCode r = AVL_EC_OK;
    AVL_uchar pBuff[7] = {0};
    ...
    r = II2C_Write_Demod(uiSlaveAddr, pBuff, 7);
...
AVL_ErrorCode GetValidModeList_Demod(AVL_puchar pucValidModeList, AVL_uint32 uiChipNo)
{
    ...
    {
        r = AVL_IBSP_WaitSemaphore(&(gsemI2C));
        r = AVL_IBSP_I2C_Write(AVL_CommonConfigChip0.usI2CAddr, pucBuffAddr, &usAddrSize);
        r |= AVL_IBSP_I2C_Read(AVL_CommonConfigChip0.usI2CAddr, pucBuffData, &usDataSize);
        r = AVL_IBSP_ReleaseSemaphore(&(gsemI2C));
    }
    else if(uiChipNo == 1)
    {
        r = AVL_IBSP_WaitSemaphore(&(gsemI2C));
        r = AVL_IBSP_I2C_Write(AVL_CommonConfigChip1.usI2CAddr, pucBuffAddr, &usAddrSize);
        r |= AVL_IBSP_I2C_Read(AVL_CommonConfigChip1.usI2CAddr, pucBuffData, &usDataSize);
        r = AVL_IBSP_ReleaseSemaphore(&(gsemI2C));
    }
...
AVL_ErrorCode Initilize_GPIOStatus_Demod(AVL_uint32 uiChipNo)
{
    ...
    r = II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr,
        gstChipInternalArray[uiChipNo].stBaseAddrSet.hw_gpio_modu_002_base + gpio_module_002_gpio_config_offset, 0x2);
...
AVL_ErrorCode AVL_ParseFwPatch_v0(AVL_uint32 uiChipNo, AVL_uchar download_only) {
...
#ifdef Internal_Debug
    int cmd_count = 0;//remove when not debugging
#endif
    AVL_ErrorCode r = AVL_EC_OK;
    ...
    while(patch_idx/4 <(script_start_idx+script_len)) 
    {
        ...
        II2C_Read32_Demod((AVL_uint16)(gstChipInternalArray[uiChipNo].usI2CAddr),(AVL_uint32)0x29A648,&tmp_top_valid);
        II2C_Read32_Demod((AVL_uint16)(gstChipInternalArray[uiChipNo].usI2CAddr),(AVL_uint32)0x0A0,&core_rdy_word);
...
#define PARSER_DEBUG
        ...
        if(condition == 1)
        {
            printf("cmd%d, core_ready_word = %x, cmd = %s\n",cmd_count++, core_rdy_word,cmd_str);
        }
#endif 
            ...
            case PATCH_CMD_VALIDATE_CRC://0
                {
                    ...
                    II2C_Write32_Demod((AVL_uint16)(gstChipInternalArray[uiChipNo].usI2CAddr),
                    ...
                    II2C_Read32_Demod((AVL_uint16)(gstChipInternalArray[uiChipNo].usI2CAddr),
                        args_addr+8,&crc_result);

                    num_rvs = AVL_patch_read32(pPatchData, &patch_idx,1);
                    rv0_idx = AVL_patch_read32(pPatchData, &patch_idx,1);
                    gstChipInternalArray[uiChipNo].variable_array[rv0_idx] = (crc_result == exp_crc_val);
                    //gstChipInternalArray[uiChipNo].variable_array[rv0_idx] = (0);
                    patch_idx += 4*(num_rvs - 1); //skip over any extraneous RV's

#ifdef Internal_Debug
                    t2 = clock() - t1;
                    printf("       PATCH_CMD_VALIDATE_CRC: %d ms, exp_crc_val = 0x%x, crc_result = 0x%x\n",t2,exp_crc_val,crc_result);
#endif
                    break;
                }
...
#define BURST
                    ...
                    r |= II2C_Write_Demod((AVL_uint16)(gstChipInternalArray[uiChipNo].usI2CAddr), pPatchDatatemp1, (AVL_uint32)(length+3));
                    ...
                    *(pPatchDatatemp1+2) = temp[0];
                    ...
                    for(AVL_uint32 i=0; i<length; i++) {
                        ...
                        r |= II2C_Write32_Demod((AVL_uint16)(gstChipInternalArray[uiChipNo].usI2CAddr),
                            dest_addr+i*4,tdata);
                    }
#endif
...
#ifdef Internal_Debug
                    t2 = clock() - t1;
                    printf("       PATCH_CMD_LD_TO_DEVICE: %d ms\n",t2);
#endif
                    break;
                }
            ...
            case PATCH_CMD_LD_TO_DEVICE_IMM://7
                {
                    ...
                    {
                        r = II2C_Write16_Demod((AVL_uint16)(gstChipInternalArray[uiChipNo].usI2CAddr),
                            dest_addr,data);                
                    } 
                    else if(length == 1) 
                    {
                        r = II2C_Write8_Demod((AVL_uint16)(gstChipInternalArray[uiChipNo].usI2CAddr),
                            dest_addr,data);                    
                    }
#ifdef Internal_Debug
                    printf("       dest_addr = 0x%x,data = 0x%x\n",dest_addr,data);
#endif
                    num_rvs = AVL_patch_read32(pPatchData, &patch_idx,1);
                    patch_idx += 4*(num_rvs); //no RV's defined yet
                    break;
            ...
            case PATCH_CMD_RD_FROM_DEVICE://8 8
                {
                    ...
                    if(length == 4)
                    {
                        /*r = II2C_Write32_Demod((AVL_uint16)(gstChipInternalArray[uiChipNo].usI2CAddr),
                            src_addr,1);*/
                        r = II2C_Read32_Demod((AVL_uint16)(gstChipInternalArray[uiChipNo].usI2CAddr),
                            src_addr,&data);
                    ...
                    {         
                        ...
                        r = II2C_Read16_Demod((AVL_uint16)(gstChipInternalArray[uiChipNo].usI2CAddr),
                            src_addr,&data1);
                    ...
                    else if(length == 1) 
                    {
                        ...
                        r = II2C_Read8_Demod((AVL_uint16)(gstChipInternalArray[uiChipNo].usI2CAddr),
                            src_addr,&data2);
                        gstChipInternalArray[uiChipNo].variable_array[rv0_idx] = data2;
                    }
#ifdef Internal_Debug
                    printf("       RD_FROM_DEVICE:src_addr = 0x%x,data = 0x%x\n",src_addr,data);
#endif
                    patch_idx += 4*(num_rvs - 1); //skip over any extraneous RV's
                    break;
                }
...
#ifdef DMA_BURST
                    r |= II2C_Write_Demod((AVL_uint16)(gstChipInternalArray[uiChipNo].usI2CAddr), pPatchDatatem1, (AVL_uint32)(num_descr*3*4));
...
#ifdef Internal_Debug
                    t2 = clock() - t1;
                    printf("       PATCH_CMD_DECOMPRESS: %d ms\n",t2);
#endif
                    break;
                }
            ...
            case PATCH_CMD_RELEASE_CPU_RESET://6
                {
                    ...
                    II2C_Write32_Demod((AVL_uint16)(gstChipInternalArray[uiChipNo].usI2CAddr), gstChipInternalArray[uiChipNo].stBaseAddrSet.hw_mcu_reset_base, 0);
            ...
            case PATCH_CMD_DMA_HW://9
                {
                    ...
                    if(num_descr >0)
                    {
                        r |= II2C_Write_Demod((AVL_uint16)(gstChipInternalArray[uiChipNo].usI2CAddr), pPatchData + patch_idx -3, (AVL_uint16)(num_descr*12+3));//not putting in >2^16 size yet, come on, thats alot of dma's...
                    }
