...
#define AVL_API_VER_MINOR                  18
#define AVL_API_VER_BUILD                  19
...
typedef enum AVL_GPIOPinNumber
{
    ...
    void Multiply32By16_Demod(AVLint64 *pY, AVL_int32 a, AVL_int16 b);
...
typedef struct AVL_BaseAddressSet
{
    ...
    AVL_uint32 hw_gpio_modu_002_base;
    AVL_uint32 hw_emerald_io_base ;
    ...
    AVL_uint32 hw_dvb_gen1_fec__base;
    ...
    typedef struct AVL_ChipInternal
    {
        ...
        AVL_uchar ucPin37Voltage; // 0 - Low; 1- High; 2 - High_Z
        AVL_uchar ucPin38Voltage;   
        AVL_uchar ucPin15Voltage;
